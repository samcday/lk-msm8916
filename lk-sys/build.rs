...
fn main() {
    ...
    let bindings = bindgen::Builder::default()
        ...
        .clang_arg("-DARM_CPU_CORTEX_A8")
        .clang_arg("-DARM_ISA_ARMV7")
        .clang_arg(format!("-I{}/app/include", lk_dir))
        .clang_arg(format!("-I{}/arch/arm/arm/include", lk_dir))
        .clang_arg(format!("-I{}/arch/arm/include", lk_dir))
        .clang_arg(format!("-I{}/arch/include", lk_dir))
        .clang_arg(format!("-I{}/dev/include", lk_dir))
        .clang_arg(format!("-I{}/kernel/include", lk_dir))
        .clang_arg(format!("-I{}/lib/console/include", lk_dir))
        .clang_arg(format!("-I{}/lib/heap/include", lk_dir))
        .clang_arg(format!("-I{}/lib/io/include", lk_dir))
